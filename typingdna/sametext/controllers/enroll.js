...
async function postData(userid, pattern) {
  try {
...
const enroll = {
    ...
    get: function (req, res) {
        ...
        postData(sessionData.internalUserId, sessionData.enrollPatterns)
    ...
    post: function (req, res) {
        ...
        req.session.save(async () => {
            ...
            if (sessionData.enrollPatterns.length >= 3) {
                console.log(sessionData.enrollPatterns);
                console.log(sessionData.internalUserId);
